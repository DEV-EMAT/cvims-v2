    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::prefix('cabvax')->group(function () {
                ...
                Route::post('verify-password', 'PatientEncodingController@verifyPassword');

                Route::post('update-summary', 'PatientEncodingController@updateEditSummary');

                Route::post('void-record', 'PatientEncodingController@voidRecord');

                Route::post('get-vasline-info', 'PatientEncodingController@vasLineInfo');
                ...
                Route::post('add-prereg-online', 'PatientEncodingController@storePreRegisteredOnline');

                Route::post('add-prereg-minor-online', 'PatientEncodingController@storePreRegisteredMinorOnline');

                Route::post('find-pre-reg-user', 'PatientEncodingController@findRegisteredUser');
